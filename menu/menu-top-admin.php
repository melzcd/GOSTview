 <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
				...
				<ul class="nav navbar-nav">
					<li class="dropdown">
					  <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Администирование<span class="caret"></span></a>
					  <ul class="dropdown-menu" role="menu">
						<li><a href="form_upload.php">Добавить ГОСТ</a></li>
						<li><a href="reg_form_user.php">Добавить пользователя</a></li>
						<li><a href="t_view1.php">Тест PDO</a></li>
					  </ul>
					</li>
                </ul>
            </div>
